...
```
rtmlaunch hrpsys_choreonoid_tutorials hrp2jsknts_choreonoid.launch PROJECT_FILE:=`rospack find hrp2jsknts_multicontact_share`/HRP2JSKNTS_LOAD_OBJ.cnoid ENVIRONMENT_YAML:=`rospack find eusurdfwrl`/worlds/room73b2.yaml

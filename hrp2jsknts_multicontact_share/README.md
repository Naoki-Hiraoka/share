...
git clone https://github.com/Naoki-Hiraoka/share -b hrp2jsknts-multicontact

wstool init .
wstool merge share/hrp2jsknts_multicontact_share/.rosinstall
wstool update
...
source ~/.bashrc
catkin build hrp2jsknts_multicontact_share
```

```
rtmlaunch hrpsys_choreonoid_tutorials hrp2jsknts_choreonoid.launch PROJECT_FILE:=`rospack find hrp2jsknts_multicontact_share`/HRP2JSKNTS_LOAD_OBJ.cnoid ENVIRONMENT_YAML:=`rospack find eusurdfwrl`/worlds/room73b2.yaml LAUNCH_FOOTCOORDS:=false
